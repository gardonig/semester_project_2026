...
class MainWindow(QMainWindow):
    def __init__(self, input_path: Optional[str] = None) -> None:
        ...
        output_dir = Path(__file__).resolve().parent.parent.parent / "data" / "posets"
    ...
    def _init_ui(self) -> None:
        ...
        if load_path is None:
            default_file = Path(__file__).resolve().parent.parent.parent / "data" / "structures" / "test_structures.json"
